          ...
          <div className="col">
            <div className="mb-3">
              ...
              <div className="input-group">
                ...
                <input onChange={handleInput} value={form.dreamWeight} name="dreamWeight" type="number" className="form-control" placeholder="Dream weight (kg)" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col">
            <div className="mb-3">
              <label className="form-label">
                {' '}
                <span className="text-primary">Last but not least:</span> When do you want to reach your dream weight?
              </label>
              <div className="input-group mb-3">
                <span className="input-group-text">In</span>
                <input onChange={handleInput} value={form.deadline} name="deadline" type="number" className="form-control" placeholder="Cheer up! It's always about time. My recommendation: 0.5--1kg/month" />
                <span className="input-group-text">Month(s)</span>
              </div>
            </div>
          </div>
        </div>
        <button className="btn btn-primary w-100">Calculate My Calories Needs</button>
      </div>
    </form>
  );
}
